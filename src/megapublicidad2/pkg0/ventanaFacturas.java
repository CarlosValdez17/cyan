...
public class ventanaFacturas extends javax.swing.JFrame {
    ...
    public ventanaFacturas(String codigo, String cliente, String tipoUsu, Connection c) {
        initComponents();
    ...
    /*
    public void enviarCorreo2(String destinatario){
       // Esto es lo que va delante de @gmail.com en tu cuenta de correo. Es el remitente también.
    String remitente = "cgermanvaldezc@gmail.com";  //Para la dirección nomcuenta@gmail.com
    //String destinatario="";
    
    Properties props = System.getProperties();
    props.put("mail.smtp.host", "smtp.gmail.com");  //El servidor SMTP de Google
    props.put("mail.smtp.user", remitente);
    props.put("mail.smtp.clave", "carlitos 7");    //La clave de la cuenta
    ...
    try {
        ...
        message.setText("Realizando pruebas de mensaje");
        Transport transport = session.getTransport("smtp");
        transport.connect("smtp.gmail.com", remitente, "carlitos 7");
    ...
    public void enviarCorreo() {
        String asunto = "Recordatorio de pago",
                ...
                + "Pixelarte agradece su preferencia.";
        String archivo = "pixelarte200px.png", ruta = "pixelarte200px.png";

        if (txtFacturaTipo.getText().equals("Cotizacion")) {
            asunto = "Cotizacion Pixelarte";
            mensaje = "Le adjunto la cotizacion";
        }

        //Constraseña pixelarte
        //vismxsnypqdhmlxw
        //Contrasaeña cgermanvaldez
        //qmhzvszdptywuvxq - la buena
        c.setContrasenia("vismxsnypqdhmlxw");
        c.setUsuarioCorreo("pixelarte.tepic@gmail.com");
        c.setAsunto(asunto);
        ...
        if (co.enviarCorreo(c)) {
            ...
            JOptionPane.showMessageDialog(this, "Error, intente de nuevo");
        }
    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        int result = JOptionPane.showConfirmDialog(null, "¿Seguro que deseas cancelar?", null, JOptionPane.YES_NO_OPTION);
        if (result == JOptionPane.YES_OPTION) {

                if (tipoUsu.equals("Ventas")) {

                    JPanel panel = new JPanel();
                    JLabel label = new JLabel("Ingresa Clave:");
                    JPasswordField pass = new JPasswordField(10);
                    panel.add(label);
                    panel.add(pass);
                    String[] options = new String[]{"OK", "Cancel"};
                    int option = JOptionPane.showOptionDialog(null, panel, "Autorización..",
                            JOptionPane.NO_OPTION, JOptionPane.PLAIN_MESSAGE,
                            null, options, options[1]);
                    if (option == 0) // pressing OK button
                    {
                        char[] password = pass.getPassword();
                        String passComparacion = String.valueOf(password);
                        if (passComparacion.equals("315529")) {
    ...
    private void botonConcretarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConcretarActionPerformed
        // TODO add your handling code here:
        ventanaCobro vc = new ventanaCobro(txtTotal.getText(), "cotizacion",tipoUsu);
        vc.facturas = this;
        vc.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            desktop.open(new java.io.File("C:\\Users\\pixel\\Documents\\Documentos Sistema\\" + txtTema.getText() + ".pdf"));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            p.pdfCotización2(txtTema.getText(), txtCodigo.getText(), txtTema.getText(), articulos, "Venta", txtFecha.getText(), txtTotal.getText(),
                    ...
                    txtComentarios.getText(), txtImp.getText(), txtSub.getText(), txtDesc.getText(), txtUsuario.getText());
