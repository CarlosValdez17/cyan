...
public class ventanaCobro extends javax.swing.JFrame {
    ...
    String totalPago, ventana, tipoUsu;
    Float total;

    private static final DecimalFormat df = new DecimalFormat("0.00");

    public ventanaCobro(String totalPago, String ventana, String tipoUsu) {
        initComponents();
    ...
    public void cambio() {
        if (!txtEfectivo.getText().equals("")) {
            ...
            if (efectivo == pago) {
                ...
                lblCambio.setText(df.format(efectivo - pago));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (ventana.equals("venta")) {
            ...
            float mitad = Float.parseFloat(totalPago) / 2;

            if (Float.parseFloat(efectivo) < mitad) {
            ...
            if (efectivo > pago) {
                ...
                if (!txtEfectivo.getText().equals("")) {
                    ...
                    if (efectivo == pago) {
                        ...
                        lblCambio.setText(df.format(pago - efectivo));
