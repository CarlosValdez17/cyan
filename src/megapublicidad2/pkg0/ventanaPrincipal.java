...
public class ventanaPrincipal extends javax.swing.JFrame {
     ...
     */
    public ventanaPrincipal(String usuario, String ico, String tipoUsu, Connection c) {
        initComponents();
    ...
    public void cargarReportes(String tipo, String where2) {
        ...
        switch (tipo) {
            case "General":
                where = " where v.estado='VENTA'";
                break;
            case "Pagados":
                where = " where v.estadoPago='COMPLETO'";
                break;
            case "Pendientes":
                where = " where v.estadoServicio='PENDIENTE'";
                break;
            case "Cancelados":
                where = " where v.estado='CANCELADO'";
                break;
            case "Cotizaciones":
                where = " where v.estado='COTIZACION'";
                break;
            case "Fechas":
                where = where2;
                break;
            case "Deudas":
                where = " where v.estadoPago='ABONO' ";
                break;
    ...
    public void limpiarCotizacion() {
        limpiar(tablaVenta1);
        txtSub1.setText("0.0");
        txtDescuento1.setText("0.0");
        txtImpuestos1.setText("0.0");
    ...
    public void cobrar(String cambio, String efectivo, String estadoPago, String tipoPago, String totalPago, String factu, String entregado) {
        Ventas v = new Ventas(cn);
        ArchivoPDF a = new ArchivoPDF(cn);
        ...
        if (status.equals("COMPLETO")) {
            ...
            tic
                    ...
                    + "================================\n"
                    + "       !!! IMPORTANTE !!!       \n"
                    + "1. No podra obtener su \n"
                    + "comprobante fiscal hasta pasadas \n"
                    + "24 hrs. desde la emision \n"
                    + "del ticket de compra. \n"
                    + "2. Para obtener comprobante \n"
                    + "fiscal digital tiene como fecha \n"
                    + "limite el ultimo dia natural \n"
                    + "del mes en curso.\n"
                    + "3. La fecha del comprobante \n"
                    + "generado correspondera a la \n"
                    + "fecha de la solicitud del mismo\n"
                    + "y no tendra a la fecha de \n"
                    + "emision del ticket.\n"
                    + "4. La factura se realizara \n"
                    + "presentando el ticket de compra.\n\n"
            ...
            try {
                a.pdfCotización(labelTema.getText(), v.folioVenta(), labelTema.getText(), articulos, "        Venta", fechaBase, txtTotal.getText(),
                        tNombre.getText(), tRepre.getText(), tTelefono.getText(), tDire.getText(), tEmail.getText(),
                        txtComentarios.getText(), txtImpuestos.getText(), txtSub.getText(), txtDescuento.getText(), labelUsuarioLog.getText(), efectivo, cambio);
...
//"C:\\Users\\pixel\\Documents\\Documentos Sistema\\" + 
            } catch (Exception ex) {
            ...
            v.RealizaVenta2(modelo, efectivo, tCliente.getText(), labelTema.getText(), totalPago, fechaBase, "VENTA",
                    tipoPago, estadoPago, factu, entregado, labelUsuarioLog.getText(),
            ...
            try {
                Desktop desktop = Desktop.getDesktop();
                desktop.open(new java.io.File("C:\\Users\\pixel\\Documents\\Documentos Sistema\\" + labelTema.getText() + ".PDF"));
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null, "No se puede abrir archivo." + ex.getMessage());
            }
    ...
    private void initComponents() {
        ...
        comisionpor = new javax.swing.JTextField();
        jLabel68 = new javax.swing.JLabel();
        comisionG = new javax.swing.JTextField();
        jLabel69 = new javax.swing.JLabel();
        comisionM = new javax.swing.JTextField();
        ...
        cmbSucursal1 = new javax.swing.JComboBox();
        ...
        jLabel67.setText("% Comision");

        comisionpor.setText("0");
        comisionpor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                comisionporKeyReleased(evt);
            }
        });

        jLabel68.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel68.setText("Comision Gral");

        comisionG.setText("0");

        jLabel69.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel69.setText("Comision Maquila");
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtPI, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jLabel17, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(txtPI2, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jLabel26, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(txtMinima, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(comisionpor, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jLabel68, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(comisionG, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jLabel69, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(comisionM, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGap(5, 5, 5)
                        .addComponent(comisionpor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                            .addComponent(jLabel69)
                            .addGap(5, 5, 5)
                            .addComponent(comisionM, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel5Layout.createSequentialGroup()
                            .addComponent(jLabel68)
                            .addGap(5, 5, 5)
                            .addComponent(comisionG, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel18.add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, -1, -1));

        buttonGroup2.add(jRadioButton2);
        jRadioButton2.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jRadioButton2.setText("Pendientes Entrega");
        jRadioButton2.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jRadioButton2ItemStateChanged(evt);
            }
        });
        jPanel18.add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 60, -1, -1));
        ...
        jPanel18.add(jRadioButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 30, -1, -1));

        primeraFecha.setOpaque(false);
        jPanel18.add(primeraFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 40, 140, -1));

        jLabel50.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel50.setText("Fecha Inicial");
        jPanel18.add(jLabel50, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 20, -1, -1));

        jLabel51.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel51.setText("Filtros de busqueda:");
        jPanel18.add(jLabel51, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        jLabel52.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel52.setText("Fecha Final");
        jPanel18.add(jLabel52, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 20, -1, -1));

        segundaFecha.setOpaque(false);
        jPanel18.add(segundaFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 40, 140, -1));
        ...
        jPanel18.add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 30, -1, -1));
        ...
        jPanel18.add(jRadioButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 30, -1, -1));
        ...
        jPanel18.add(jButton40, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 40, -1, -1));
        ...
        jPanel18.add(jButton41, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 40, -1, -1));

        buttonGroup2.add(jRadioButton10);
        jRadioButton10.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jRadioButton10.setText("Pendientes Pago");
        jRadioButton10.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jRadioButton10ItemStateChanged(evt);
            }
        });
        jPanel18.add(jRadioButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1, -1));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos Generales", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), java.awt.Color.white)); // NOI18N
        ...
        tablaUsuarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Contraseña", "Sucursal", "Tipo Usuario"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false
        ...
        jPanel11.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Opciones", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        jLabel66.setText("Permisos");

        cmbSucursal1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Administrador", "Ventas" }));
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel10Layout.createSequentialGroup()
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtNombreU, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cmbSucursal, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel66)
                            .addComponent(cmbSucursal1, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel10Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel10Layout.createSequentialGroup()
                                .addComponent(jLabel66)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cmbSucursal1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGap(18, 18, 18)
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel10Layout.createSequentialGroup()
        ...
        jButton20.setText("Pendientes Entrega");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Nombre", "Concepto", "Fecha", "Total" }));
        ...
        jButton58.setBackground(new java.awt.Color(204, 102, 255));
        jButton58.setText("Pendientes Pago");
        ...
        jButton59.setBackground(new java.awt.Color(27, 51, 94));
        jButton59.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        jButton59.setForeground(new java.awt.Color(255, 255, 255));
        jButton59.setText("Cerrar Sesion");
        ...
        jLabel61.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/barraMega_1.jpg"))); // NOI18N
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        prenderBoton(jButton5, panelClientes);
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        prenderBoton(jButton6, panelProductos);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        prenderBoton(jButton10, panelVentas);
    }//GEN-LAST:event_jButton10ActionPerformed

    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        // TODO add your handling code here:
        ventanaArticulos va = new ventanaArticulos("VENTAS", cn);
        va.ventas = this;
        va.setVisible(true);
    ...
    private void jBAñadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAñadirActionPerformed
        // TODO add your handling code here:
        Generales U = new Generales(cn);

        String tipo = cmbSucursal.getSelectedItem() + "";
        String tipoUsu = cmbSucursal1.getSelectedItem() + "";

        U.añadirUsu(txtNombreU.getText(), txtApellido.getText(), txtContra.getText(), tipo, icono, tipoUsu);
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        corteCaja cc = new corteCaja(labelUsuarioLog.getText(), cn);
        cc.prin = this;
        cc.setVisible(true);
        //}
    ...
    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        prenderBoton(jButton23, panelFacturas);
    ...
    private void jButton25ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton25ActionPerformed
        // TODO add your handling code here:
        ventanaGranFormato va = new ventanaGranFormato("VENTA", cn);
        va.ventas = this;
        va.setVisible(true);
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        if (labelTema.getText().equals("-")) {
            ...
            ventanaCobro vc = new ventanaCobro(txtTotal.getText(), "venta", tipoUsu);
            vc.ventas = this;
            vc.setVisible(true);
        }
    ...
    public void desglozarImpuestosCoti() {
        try {
            double impuestos = 0.00, total = 0.00, simp = 0.0;
            String sub = "", imp = "";
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        // TODO add your handling code here:
        ventanaDescuento vd = new ventanaDescuento("VENTA", cn);
        vd.principal = this;
        vd.setVisible(true);
    ...
    private void tablaOrdenesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaOrdenesMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ventanaFacturas vf = new ventanaFacturas(codigo, cliente, tipoUsu, cn);
            vf.setVisible(true);
        }
    ...
    private void jButton30ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton30ActionPerformed
        prenderBoton(jButton30, panelCotizaciones);
    }//GEN-LAST:event_jButton30ActionPerformed

    private void jButton31ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton31ActionPerformed
        // GRAN FORMATO - PANEL COTIZACIONES
        ventanaGranFormato va = new ventanaGranFormato("COTI", cn);
        va.ventas = this;
        va.setVisible(true);
...
// TODO add your handling code here:
    ...
    private void jButton34ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton34ActionPerformed
        ...
        ventanaArticulos va = new ventanaArticulos("COTI", cn);
        va.ventas = this;
        va.setVisible(true);
    ...
    private void jButton35ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton35ActionPerformed
        ...
        ventanaDescuento vd = new ventanaDescuento("COTI", cn);
        vd.principal = this;
        vd.setVisible(true);

    }//GEN-LAST:event_jButton35ActionPerformed
    String estadoImpuesto = "N", estadoImpuesto2 = "N";
            ...
            if (labelTema1.getText().equals("-")) {
                ...
                try {
                    p.pdfCotización(labelTema1.getText(), v.folioVenta(), labelTema1.getText(), articulos, "Cotizacion", fechaBase, txtTotal1.getText(),
                            tNombre1.getText(), tRepre1.getText(), tTelefono1.getText(), tDire1.getText(), tEmail1.getText(),
    ...
    private void jButton38ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton38ActionPerformed
        prenderBoton(jButton38, panelCorteCaja);
    }//GEN-LAST:event_jButton38ActionPerformed

    private void jButton39ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton39ActionPerformed
        prenderBoton(jButton39, panelReportes);
    ...
    private void jButton41ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton41ActionPerformed
        ...
        try {
            ...
            if (jRadioButton1.isSelected()) {
                cargarReportes("Fechas", " where v.fecha= '" + f1 + "' ");
            } else if (jRadioButton2.isSelected()) {
                //PENDIENTES
                cargarReportes("Fechas", " where v.estadoServicio='PENDIENTE' and v.fecha='" + f1 + "' ");
            } else if (jRadioButton3.isSelected()) {
                //CANCELADOS
                cargarReportes("Fechas", " where v.estado='CANCELADO' and v.fecha='" + f1 + "'");
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        try {
            ...
            if (archivo == null || archivo.equals("")) {
                ...
                Desktop desktop = Desktop.getDesktop();
                desktop.open(new java.io.File("C:\\Users\\pixel\\Documents\\Documentos Sistema\\Reportes\\" + archivo + ".pdf"));
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        prenderBoton(jButton14, panelUsuarios);
    ...
    private void jButton40ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton40ActionPerformed
        ...
        try {
            ...
            if (jRadioButton1.isSelected()) {
                cargarReportes("Fechas", " where v.fecha between '" + f1 + "' and '" + f2 + "' ");
            } else if (jRadioButton2.isSelected()) {
                //PENDIENTES
                cargarReportes("Fechas", " where v.estadoServicio='PENDIENTE' and v.fecha between '" + f1 + "' and '" + f2 + "' ");
            } else if (jRadioButton3.isSelected()) {
                //CANCELADOS
                cargarReportes("Fechas", " where v.estado='CANCELADO' and v.fecha between '" + f1 + "' and '" + f2 + "'");
            } else if (jRadioButton4.isSelected()) {
                //COTIZACIONES
    ...
    private void jButton43ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton43ActionPerformed
        prenderBoton(jButton43, panelInicio);
    ...
    private void tablaFacturasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaFacturasMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            vetanaDetalleFactura vdf = new vetanaDetalleFactura(codFac, clienteFac, "FACTURA", cn);
            vdf.princ = this;
            vdf.setVisible(true);
        }
    ...
    private void tablaTransMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaTransMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            vetanaDetalleFactura vdf = new vetanaDetalleFactura(codTrans, clienteTrans, "TRANSFERENCIA", cn);
            vdf.princ = this;
            vdf.setVisible(true);
        }
    ...
    private void jButton50ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton50ActionPerformed
        prenderBoton(jButton50, panelContador);
    ...
    private void jButton53ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton53ActionPerformed
        // Categorias
        ventanaCategorias vcat = new ventanaCategorias(cn);
        vcat.vprin = this;
    ...
    private void jButton57ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton57ActionPerformed
        // TODO add your handling code here:
        ventanaGastos vgas = new ventanaGastos(cn);
        vgas.setVisible(true);
    }//GEN-LAST:event_jButton57ActionPerformed

    private void jButton58ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton58ActionPerformed
        // TODO add your handling code here:
        iniciaOrdenes("deudas");
    ...
    private void jRadioButton10ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jRadioButton10ItemStateChanged
        // TODO add your handling code here:
        cargarReportes("Deudas", "");
        labelAviso.setText("Listado de pendientes de pago");
        sumaReportes();
    ...
    private void comisionporKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_comisionporKeyReleased
        // TODO add your handling code here:
        try {
            float preciog = Float.parseFloat(txtPI.getText());
            float preciom = Float.parseFloat(txtPI2.getText());
            float porcentaje = Float.parseFloat(comisionpor.getText());
