...
public class ventanaGastos extends javax.swing.JFrame {
    ...
    public ventanaGastos(Connection c) {
        initComponents();
    ...
    public void iniciaTabla() {
        limpiar(jTable1);
        cortedeCaja u = new cortedeCaja(cn);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Entradas
        try {
            if (txtConcepto.getText().length() == 0 && txtTotal.getText().length() == 0) {
                JOptionPane.showMessageDialog(this, "Rellena todos los campos");
            } else {
                String sql = "insert into gastos values(null, '" + txtConcepto.getText() + "','" + txtTotal.getText() + "', 'Entrada', '" + fecha + "') ";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            if (txtConcepto.getText().length() == 0 && txtTotal.getText().length() == 0) {
                ...
                String sql = "insert into gastos values(null, '" + txtConcepto.getText() + "',"
                        + " '" + total + "','Salida','" + fecha + "') ";
